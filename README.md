...
- **Right-click context menu** on backup sets — quick access to all operations (Backup, Restore, Modify, Cleanup, Backup Coverage, Verify Integrity, Largest Files, Copy, Change Destination, Remap Source Drive, Export)
